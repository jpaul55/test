    ...
    const handleSaveProgramIds = async () => {
      try {
        ...
        programItems.forEach(currentItem => {
          ...
          if (originalItem) {
            // Check if any editable field was changed
            const hasChanges = 
              currentItem.programDescription !== originalItem.programDescription ||
              currentItem.clientId !== originalItem.clientId ||
              currentItem.senderName !== originalItem.senderName ||
              currentItem.senderEmail !== originalItem.senderEmail;
            ...
            if (hasChanges) {
              ...
              itemsToSave.push({
                ...
                oauthClientId: currentItem.clientId || '',
